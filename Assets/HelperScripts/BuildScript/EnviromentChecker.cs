...
public class EnviromentChecker : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (enviromentVariables.ContainsKey("BUNDLE_VERSION_ANDROID"))
        {
            Debug.Log("Found Bundle version for android " + enviromentVariables["BUNDLE_VERSION_ANDROID"]);
            bundleVersionAndroid.SetValue(enviromentVariables["BUNDLE_VERSION_ANDROID"]);
        }
        if (enviromentVariables.ContainsKey("BUNDLE_VERSION_IOS"))
        {
            Debug.Log("Found Bundle version for IOS " + enviromentVariables["BUNDLE_VERSION_IOS"]);
            bundleVersionAndroid.SetValue(enviromentVariables["BUNDLE_VERSION_IOS"]);
        }
    }
}
